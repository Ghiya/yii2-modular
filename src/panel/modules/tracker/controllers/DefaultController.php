...
namespace modular\panel\modules\tracker\controllers;
 ...
 *
 * @package modular\panel\modules\tracker\controllers
 */
class DefaultController extends Controller
{


    public $viewPath = '@modular/panel/modules/tracker/views/default';
